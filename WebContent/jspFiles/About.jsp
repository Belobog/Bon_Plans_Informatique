...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			...
			<p>Nous sommes un groupe de jeunes gens passionés par ce que nous faisons,
			nous venons de tous les milieux et de tous les domaines.</p>
			
		</div>
		<div class="container">
			<h1 id="pourquoi">Pourquoi ce site ?</h1>
			<p>Pour partager notre savoir avec vous et pour que vous aussi 
			vous puissiez partager le votre avec vos amis vos voisins et avec la planète entière
			</p>
